$exportpath = "c:\temp\anomalies.csv"
...
$url = "https://graph.microsoft.com/beta/deviceManagement/userExperienceAnalyticsAnomaly?=&`$orderBy=severity asc"
...
if ($result -eq [System.Windows.Forms.DialogResult]::OK) {
    ...
    $anomalydetailsurl = "https://graph.microsoft.com/beta/deviceManagement/userExperienceAnalyticsAnomaly/$anomalyid"
    $anomalydetails = Invoke-MgGraphRequest -Uri $anomalydetailsurl -Method Get -OutputType PSObject
