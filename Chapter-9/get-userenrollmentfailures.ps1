...
##Select single user or all users
...
$url = "https://graph.microsoft.com/beta/deviceManagement/troubleshootingEvents"
} elseif ($result -eq [System.Windows.Forms.DialogResult]::Cancel) {
    $selecteditems = $allusers | select-object userPrincipalName, id | Out-GridView -Title "Pick a user to drill-down" -PassThru
    foreach ($selected in $selecteditems) {
        $userid = $selected.id
        $url = "https://graph.microsoft.com/beta/users/$userid/deviceManagementTroubleshootingEvents"
    }
}
