...
$url = "https://graph.microsoft.com/beta/deviceManagement/deviceConfigurationRestrictedAppsViolations"

$allapps = getallpagination -url $url

$applist = $allapps | Select-Object * -ExpandProperty restrictedapps | select-object userName, deviceName, managedDeviceID, deviceConfigurationName, platformType, restrictedAppsState, appId
