...
$installstring = "&.\remotehelpinstaller.exe /quiet acceptTerms=1"
$uninstallstring = "&.\remotehelpinstaller.exe /uninstall /quiet acceptTerms=1"
...
################################################# END FUNCTIONS ###################################################################
    ...
    Invoke-WebRequest -Uri $appoutput -OutFile $appdownloadurl
